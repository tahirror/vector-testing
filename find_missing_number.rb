...
p find_missing_number_1([1,3,4,6,8,5,7])
...
p find_missing_number_2([1,3,4,6,8,5,7])
...
def find_missing_number_3(a)
  n = a.length+1
  range = Array (1..n)
  missing_element = range - a
end

p find_missing_number_3([1,3,4,6,8,5,7])