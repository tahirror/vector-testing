...
#Pythagorean triplets:3 no.'s for which sum of squares of any two == any third number in array.
...
p pythagorean_triplet([1,2,3,3,34,4,4]) # => -1
p pythagorean_triplet([1,2,3,3,34,13,12,5]) # => Triplet found 5,12,13